    ...
    logs: {
      ...
      Migration: {
        Update: [
          ...
          '<code>src/components/dashboards/dashboard/SharedFiles.js</code>',
          '<code>src/components/dashboards/dashboard/MarketShare.js</code>',
          '<code>src/components/dashboards/dashboard/RunningProjects.js</code>',
          '<code>src/components/dashboards/dashboard/StorageStatus.js</code>',
    ...
    logs: {
      ...
      Migration: {
        ...
        Update: [
          ...
          '<code>src/components/dashboards/dashboard/ActiveUsers.js</code>',
          '<code>src/components/dashboards/dashboard/BandwidthSaved.js</code>',
          '<code>src/components/dashboards/dashboard/index.js</code>',
    ...
    logs: {
      ...
      Migration: {
        ...
        Update: [
          ...
          '<code>src/components/dashboards/dashboard/MarketShare.js</code>',
          '<code>src/components/dashboards/dashboard/SharedFiles.js</code>',
          '<code>src/components/dashboards/dashboard/TopProducts.js</code>',
          '<code>src/components/dashboards/dashboard/TotalOrder.js</code>',
          '<code>src/components/dashboards/dashboard/WeeklySales.js</code>',
          '<code>src/components/dashboards/dashboard/index.js</code>',
          '<code>src/components/documentation/Plugins.js</code>',
          '<code>src/data/common.js</code>',
          '<code>src/data/dashboard/analytics.js</code>',
          '<code>src/data/dashboard/dashboard.js</code>',
  ...
  },
  {
    ...
    logs: {
      New: [
        ...
        'Page : <code> Pricing dashboard </code>',
